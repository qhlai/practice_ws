...
if("TRUE" STREQUAL "TRUE")
  set(track_pkg_SOURCE_PREFIX /home/uestc/HL_ws/src/tracker_kcf_ros/src/track_pkg)
  set(track_pkg_DEVEL_PREFIX /home/uestc/HL_ws/src/tracker_kcf_ros/devel)
  ...
  set(track_pkg_INSTALL_PREFIX /home/uestc/HL_ws/src/tracker_kcf_ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'track_pkg' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/uestc/HL_ws/src/tracker_kcf_ros/src/track_pkg/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/uestc/HL_ws/src/tracker_kcf_ros/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(track_pkg_EXPORTED_TARGETS ${${track_pkg_dep}_EXPORTED_TARGETS})
endforeach()
